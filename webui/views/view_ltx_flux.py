...
def render_view():
    ...
    st.caption("Generación de vídeo multimodal con audio nativo 48kHz y control óptico de cámara.")
    ...
    with col_left:
        ...
        uploaded_frame = st.file_uploader("Fotograma Maestro Inicial (Image-to-Video)", type=["jpg", "png", "webp"])
...
[SCORE]: {c4}"""
        ...
        st.markdown("#### Fotogramas Maestros de Referencia DoP")
