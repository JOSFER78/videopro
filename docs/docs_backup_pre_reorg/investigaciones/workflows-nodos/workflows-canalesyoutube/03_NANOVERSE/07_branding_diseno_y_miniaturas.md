...
graph LR
    ...
    style B fill:#ff007f,stroke:#333,stroke-width:1px,color:#000
    style C fill:#7928ca,stroke:#333,stroke-width:1px,color:#000
    style D fill:#00f0ff,stroke:#333,stroke-width:1px,color:#000
```
...
2. **Contraste Cromático:** Uso de la paleta `#ff007f` sobre fondos oscuros o complementarios `#7928ca`.
