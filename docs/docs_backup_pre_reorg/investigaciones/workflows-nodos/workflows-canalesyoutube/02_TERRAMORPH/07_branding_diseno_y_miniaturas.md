...
graph LR
    ...
    style B fill:#00e676,stroke:#333,stroke-width:1px,color:#000
    style C fill:#ff9100,stroke:#333,stroke-width:1px,color:#000
    style D fill:#2979ff,stroke:#333,stroke-width:1px,color:#000
```
...
2. **Contraste Cromático:** Uso de la paleta `#00e676` sobre fondos oscuros o complementarios `#ff9100`.
