...
graph LR
    ...
    style B fill:#7c4dff,stroke:#333,stroke-width:1px,color:#000
    style C fill:#00e5ff,stroke:#333,stroke-width:1px,color:#000
    style D fill:#ff3d00,stroke:#333,stroke-width:1px,color:#000
```
...
2. **Contraste Cromático:** Uso de la paleta `#7c4dff` sobre fondos oscuros o complementarios `#00e5ff`.
