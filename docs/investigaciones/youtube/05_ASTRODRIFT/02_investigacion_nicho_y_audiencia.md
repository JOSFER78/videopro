...
1. **Modo Relajación y Fondo (*Lean-Back*):** Usuarios que ponen el canal en su Smart TV 4K mientras estudian, trabajan, leen o se relajan antes de dormir. La música a `105 BPM` y el movimiento fluido sin saltos bruscos garantizan sesiones de más de 30 minutos.
...
* **5–30 segundos (Establecimiento del Vínculo):** Integración de música Space Chillstep / Cinematic Synthwave & Cosmic Frequencies y primer rótulo de telemetría HUD 3D.
