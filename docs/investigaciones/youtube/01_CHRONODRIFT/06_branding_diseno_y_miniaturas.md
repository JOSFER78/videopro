...
graph LR
    ...
    style B fill:#00e5ff,stroke:#333,stroke-width:1px,color:#000
    style C fill:#ffb300,stroke:#333,stroke-width:1px,color:#000
    style D fill:#b388ff,stroke:#333,stroke-width:1px,color:#000
```
...
2. **Contraste Cromático:** Uso de la paleta `#00e5ff` sobre fondos oscuros o complementarios `#ffb300`.
