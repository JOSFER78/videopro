# 🎨 CHRONODRIFT: Auditoría de Branding, Identidad de Canal y Diseño de 5 Fórmulas de Miniaturas de Alto CTR (>15%)

> **Documento Oficial:** `06_branding_diseno_y_miniaturas.md`  
> **Canal:** CHRONODRIFT (`@ChronoDriftOfficial`)  
> **Objetivo de Rendimiento:** Click-Through Rate (CTR) > 15.4% (Audiencias Tier-1 Globales), Retención 1er Minuto > 91%  
> **Ecosistema de Producción:** `videopro` / `google_flow` / `FLUX 1.1 Pro` / `Midjourney v6.1` / `Remotion`  
> **Estado:** Documento Maestro Aprobado para Producción
...
3. [Identidad Visual del Canal & Sistema de Marca](#3-identidad-visual-del-canal--sistema-de-marca)
   - [3.1 Direcciones Conceptuales de Logotipo](#31-direcciones-conceptuales-de-logotipo)
   - [3.2 Paleta Cromática Extendida (8 Tokens Oficiales)](#32-paleta-cromática-extendida-8-tokens-oficiales)
   - [3.3 Sistema Tipográfico Display y Telemetría](#33-sistema-tipográfico-display-y-telemetría)
   - [3.4 Especificaciones para Banner YouTube (2560×1440) y Avatar (800×800)](#34-especificaciones-para-banner-youtube-25601440-y-avatar-800800)
   - [3.5 Identidad Sonora: Firma de Audio (Audio Mnemonic 1.5s)](#35-identidad-sonora-firma-de-audio-audio-mnemonic-15s)
4. [Arquitectura de Ingeniería Visual para Miniaturas de Alto CTR (>15%)](#4-arquitectura-de-ingeniería-visual-para-miniaturas-de-alto-ctr-15)
   - [4.1 Anatomía del Canvas 16:9 & Zonas Seguras de YouTube](#41-anatomía-del-canvas-169--zonas-seguras-de-youtube)
   - [4.2 Jerarquía de Flujo Ocular & Mapas de Calor](#42-jerarquía-de-flujo-ocular--mapas-de-calor)
   - [4.3 Sistema de Colorimetría de Alto Contraste & WCAG AAA](#43-sistema-de-colorimetría-de-alto-contraste--wcag-aaa)
   - [4.4 Tipografía Mobile-First & Tratamiento de Borde (Stroke)](#44-tipografía-mobile-first--tratamiento-de-borde-stroke)
   - [4.5 Capa de Integración 3D, LiDAR y Telemetría HUD](#45-capa-de-integración-3d-lidar-y-telemetría-hud)
   - [4.6 Regla de Oro del Copy (Máximo 3 a 4 Palabras)](#46-regla-de-oro-del-copy-máximo-3-a-4-palabras)
5. [Las 5 Fórmulas Maestras de Miniaturas (Guías Visuales & Prompts de Generación)](#5-las-5-fórmulas-maestras-de-miniaturas-guías-visuales--prompts-de-generación)
...
6. [Matriz de Sinergia Título + Miniatura (Anti-Clickbait & Click-Trigger)](#6-matriz-de-sinergia-título--miniatura-anti-clickbait--click-trigger)
7. [Protocolo de A/B Testing, Test 50×50px & Checklist Pre-Publicación](#7-protocolo-de-ab-testing-test-5050px--checklist-pre-publicación)

---

## 1. Resumen Ejecutivo & Objetivos Estratégicos

El presente informe establece la base científica, lingüística y de diseño visual para consolidar la marca **CHRONODRIFT** y garantizar un Click-Through Rate (CTR) sostenido superior al **15%** en YouTube para audiencias globales de alto valor (mercados Tier-1: Estados Unidos, Reino Unido, Alemania, Canadá, Australia, Japón y España).

```mermaid
flowchart LR
    A[Impresión en Feed / Sugeridos] --> B{Impacto Visual < 0.3s}
    B -->|Fórmula Alto CTR| C[Focal Point 1: Objeto Imposible / Contraste]
    C --> D[Focal Point 2: Micro-Copy Paradoja 3-4 Palabras]
    D --> E[Focal Point 3: HUD Telemetría / Wireframe 3D]
    E --> F[Clic Seguro: CTR > 15%]
    F --> G[Retención 1er Minuto > 91%]
```

### Objetivos Cuantitativos Clave:
- **CTR Objetivo en Browse Features (Página Principal):** `14.5% – 18.2%`
- **CTR Objetivo en Suggested Videos (Vídeos Recomendados):** `16.0% – 21.5%`
- **Tiempo de fijación ocular promedio:** `< 250 milisegundos` (reconocimiento instantáneo).
- **Legibilidad móvil (50×50 px en feed de smartphone):** `100% de comprensión del mensaje central`.
- **Sinergia Título + Miniatura:** Cero redundancia léxica (la imagen plantea una incógnita visual imposible y el título aporta el anclaje de contexto científico).
...
- **Pronunciación en Inglés:** Fluida y natural. Suena a título de videojuego AAA o blockbuster cinematográfico.
...
mindmap
  root((CHRONODRIFT))
    Tiempo
      Chrono = Raíz griega Kronos
      Precisión de cronómetro suizo
      Viajes en el tiempo 1626 -> 2226
      Misterio histórico
    Movimiento
      Drift = Deslizamiento controlado
      Vuelo FPV cinemático ininterrumpido
      Transición fluida entre dimensiones
      Adrenalina sin cortes bruscos
    Percepción de Marca
      Cine documental de alta gama
      Cero percepción de 'AI Slop'
      Cultura urbana contemporánea + Lo-Fi
```
...
## 3. Identidad Visual del Canal & Sistema de Marca

### 3.1 Direcciones Conceptuales de Logotipo

1. **Dirección 1 (Minimalista / Tech - Vórtice HUD Tritemporal):** Hexágono segmentado en 3 arcos concéntricos con mira FPV y corchetes HUD. Optimizado para visualización en 32×32px y overlay de vídeo.
2. **Dirección 2 (Vintage de Aviación / Retrofuturista - Aero-Cronómetro Mach-3):** Escala taquimétrica analógica de caza supersónico atravesada por alas en delta y triple marcación horaria (1626, 2026, 2226).
3. **Dirección 3 (Abstracto / Cuántico - Bucle de Möbius 4D):** Cinta de Möbius en ángulo isométrico representando el continuo espacio-tiempo y la fluidez del drift.

---

### 3.2 Paleta Cromática Extendida (8 Tokens Oficiales)

| Token de Color | Código HEX | Rol en la Miniatura & Canal | Ratio Contraste vs Negro (`#07090E`) |
| :--- | :--- | :--- | :---: |
| **Cian Neón Cuántico** | `#00E5FF` | Primario / Hilos LiDAR / Halos / Retículas HUD | **14.8 : 1** (Ultra Legible) |
| **Naranja Hiperimpulso** | `#FFB300` | Secundario / Títulos de impacto / Énfasis / Alertas | **12.6 : 1** (Impacto Máximo) |
| **Blanco Fotónico Puro** | `#FFFFFF` | Cuerpo del texto display primario / Highlights | **19.5 : 1** (Legibilidad Absoluta) |
| **Lila Distorsión 4D** | `#B388FF` | Vórtices cuánticos / Cielos futuros / Energía | **10.2 : 1** |
| **Negro Abisal Void** | `#07090E` | Base de fondo OLED / Sombras / Profundidad espacial | Base de Profundidad |
| **Titanio Carbón** | `#161B26` | Cajas de datos / Paneles UI / Tarjetas | Intermedio |
| **Ámbar Histórico** | `#D4A373` | Época histórica (1626) / Sepia / Cálidos | **7.8 : 1** |
| **Violeta Hiperespacio**| `#7C4DFF` | Época futura (2226) / Neón profundo | **6.5 : 1** |

---

### 3.3 Sistema Tipográfico Display y Telemetría

* **Display / Títulos de Miniatura:** `Syne` (Weight: 800 ExtraBold, Tracking: -0.04em, Leading: 0.85em) — Alternativa: `Space Grotesk` (700 Bold) o `Bebas Neue`.
* **Telemetría HUD & Datos:** `JetBrains Mono` / `Share Tech Mono` (Tabular numbers, Tracking: +0.05em).
* **Cuerpo de Texto y Subtítulos:** `Plus Jakarta Sans` / `Inter` (Regular 400 / SemiBold 600).

---

### 3.4 Especificaciones para Banner YouTube (2560×1440) y Avatar (800×800)

* **Banner YouTube (2560×1440 px):**
  - **Tríptico Temporal Continuo:** Pasado 1626 en el tercio izquierdo (madera/faroles), Dron FPV central sobrepasando la Safe Zone (1546×423 px) con skyline contemporáneo 2026, y Megaciudad futurista 2226 en el tercio derecho.
  - **Safe Area Móvil (1546×423 px):** Contiene el logotipo `CHRONODRIFT` en tipografía display `#FFFFFF` con reborde cian `#00E5FF`, el claim *"THE 400-YEAR FPV JOURNEY"* y el selector temporal `1626 // 2026 // 2226`.
* **Avatar Social (800×800 px):**
  - Isotipo Vórtice HUD centrado dentro del círculo de seguridad de 720px sobre fondo Negro Abisal `#07090E`, con halo perimetral Cian Neón `#00E5FF` y corchetes en las 4 esquinas.

---

### 3.5 Identidad Sonora: Firma de Audio (Audio Mnemonic 1.5s)

* **Especificaciones Técnicas:** WAV 48kHz / 24-bit PCM, -14.0 LUFS integrado, -1.0 dBTP True Peak.
* **Estructura de 4 Capas Acústicas:**
  - `0.00s - 0.90s`: Caída sub-bass (80Hz ➔ 38Hz) generando impacto físico visceral.
  - `0.10s - 0.70s`: Barrido estéreo FPV Warp L➔R con efecto flanger / doppler aéreo.
  - `0.35s - 0.75s`: Micro-clicks digitales HUD (4.2 kHz) de fijación de objetivo.
  - `0.60s - 1.50s`: Acorde sintetizador Cmaj9 con cola de reverberación shimmer en desvanecimiento natural.

---

## 4. Arquitectura de Ingeniería Visual para Miniaturas de Alto CTR (>15%)

Las miniaturas de **CHRONODRIFT** no son capturas estáticas; son **piezas de alta ingeniería visual diseñadas para secuestrar la atención del usuario en menos de 250 milisegundos**.

---

### 4.1 Anatomía del Canvas 16:9 & Zonas Seguras de YouTube

El lienzo de diseño base es **1920×1080 píxeles** (relación 16:9). Se deben respetar rigurosamente las **Safe Zones** para evitar colisiones con los elementos de la interfaz de YouTube:
...
### 4.2 Jerarquía de Flujo Ocular & Mapas de Calor
...
```mermaid
graph TD
    A[Punto de Entrada: Elemento Imposible / Contraste Cromático Extremo] -->|0 a 80 ms| B[Punto de Anclaje: Copy Display de 2-4 Palabras con Stroke]
    B -->|80 a 180 ms| C[Punto de Contexto: Interfaz HUD / Escáner LiDAR / Diales]
    C -->|180 a 250 ms| D[Disparo Cognitivo: 'Tengo que ver cómo ocurrió esto' -> CLIC]
```
...
### 4.3 Sistema de Colorimetría de Alto Contraste & WCAG AAA
...
### 4.4 Tipografía Mobile-First & Tratamiento de Borde (Stroke)
...
```
                         [ SISTEMA DE 4 CAPAS DE TEXTO ]

      Capa 1 (Superior):    Texto Relleno -> #FFFFFF o #FFB300 (Gradient sutil)
      Capa 2 (Intermedia):  Stroke Exterior -> 12px a 16px en #07090E (Solid Black)
      Capa 3 (Profundidad): Sombra Direccional -> Blur 8px, Offset Y: 8px, Opacidad 90%
...
### 4.5 Capa de Integración 3D, LiDAR y Telemetría HUD
...
### 4.6 Regla de Oro del Copy (Máximo 3 a 4 Palabras)

- **Límite Estricto:** **MÁXIMO 3 A 4 PALABRAS**.
- **Función:** Generar un *information gap* (brecha de curiosidad) que solo puede resolverse haciendo clic.
- **Anti-Clickbait:** La promesa planteada por las 4 palabras debe cumplirse rigurosamente en los primeros 10 segundos del vídeo.
- **Anti-Redundancia:** Jamás repetir el título del vídeo en la miniatura.

---

## 5. Las 5 Fórmulas Maestras de Miniaturas (Guías Visuales & Prompts de Generación)
...
#### 🔗 Sinergia Título + Miniatura:
- **Copy Miniatura:** `400 YEARS VANISHED`
- **Título YouTube:** *Tokyo in 1626 vs 2026 vs 2226: 400-Year FPV Evolution in 4K*
...
#### 🔗 Sinergia Título + Miniatura:
- **Copy Miniatura:** `140 KM/H DIVE`
- **Título YouTube:** *Diving Through 400 Years of New York (Lenape Forest to 2226 Megacity)*
...
#### 🔗 Sinergia Título + Miniatura:
- **Copy Miniatura:** `PORTAL OPENED`
- **Título YouTube:** *We Rebuilt Paris in 1620, 2026 and 2226 (Scientific 3D FPV Drone)*
...
#### 🔗 Sinergia Título + Miniatura:
- **Copy Miniatura:** `DEEP SCAN 3D`
- **Título YouTube:** *LiDAR Scanning the Great Pyramids: 4,000 Years of Hidden Urban History*
...
#### 🔗 Sinergia Título + Miniatura:
- **Copy Miniatura:** `DUBAI 2226`
- **Título YouTube:** *Dubai: From Desert Pearl Village (1820) to 3km Super-Arcology (2226)*

---

## 6. Matriz de Sinergia Título + Miniatura (Anti-Clickbait & Click-Trigger)

El CTR masivo no se genera con la miniatura aislada, sino con el **candado cognitivo** que surge cuando la miniatura y el título se complementan sin repetirse:
...
| Episodio | Fórmula Utilizada | Copy en Miniatura (≤ 4 Palabras) | Título de YouTube Optimizado (SEO + CTR) | Gatillo Psicológico |
| :--- | :--- | :--- | :--- | :--- |
| **Ep. 01: Tokio** | Fórmula 1 (Split 3-Way) | `400 YEARS VANISHED` | *Tokyo in 1626 vs 2026 vs 2226: 400-Year FPV Evolution in 4K* | Contraste extremo y curiosidad histórica |
| **Ep. 02: Nueva York** | Fórmula 2 (FPV Dive) | `140 KM/H DIVE` | *Diving Through 400 Years of New York (Lenape Forest to 2226 Megacity)* | Adrenalina de vértigo y escala |
| **Ep. 03: Londres** | Fórmula 1 (Split 3-Way) | `THEY HID THIS` | *Flying Through Tudor London (1610) into the 2226 Sky-Canopy* | Secreto revelado y misterio arquitectónico |
| **Ep. 04: París** | Fórmula 3 (Portal Cuántico) | `PORTAL OPENED` | *We Rebuilt Paris in 1620, 2026 and 2226 (Scientific 3D FPV Drone)* | Fascinación por la física y reconstrucción |
| **Ep. 05: Ámsterdam** | Fórmula 5 (Scale Shock) | `WATER TOOK OVER` | *Amsterdam’s 400-Year Fight Against the Sea (1626 ➔ 2226 Ocean-Grid)* | Urgencia climática y supervivencia urbana |
| **Ep. 06: Roma** | Fórmula 4 (LiDAR 3D) | `ROMA SECRETA 3D` | *Inside Rome’s Underground: From Baroque Basilica to Cyber-Antiquity 2226* | Escaneo arqueológico profundo |
| **Ep. 07: Dubái** | Fórmula 5 (Scale Shock) | `DUBAI 2226` | *Dubai: From Desert Pearl Village (1820) to 3km Super-Arcology (2226)* | Transformación radical y megalomanía |
| **Ep. 08: Hong Kong** | Fórmula 2 (FPV Dive) | `DENSITY LIMIT` | *Hong Kong’s Vertical Abyss: 1840 Fishing Bay to 800m Stratospheric Bridges* | Claustrofobia y gigantismo vertical |
| **Ep. 09: El Cairo** | Fórmula 4 (LiDAR 3D) | `DEEP SCAN 3D` | *LiDAR Scanning the Great Pyramids: 4,000 Years of Hidden Urban History* | Revelación de datos arqueológicos |
| **Ep. 10: Venecia** | Fórmula 3 (Portal Cuántico) | `BEFORE IT SINKS` | *Venice in 1626, 2026 and 2226: The Submerged Future of the Floating City* | Miedo a la pérdida y asombro visual |

---

## 7. Protocolo de A/B Testing, Test 50×50px & Checklist Pre-Publicación
...
### 7.1 El "Test del Móvil a 50×50 Píxeles"
...
2. **¿El texto de 3-4 palabras puede leerse con total claridad?** (Sí/No)
3. **¿El contraste cromático separa nítidamente el fondo del elemento en primer plano?** (Sí/No)  
*Si alguna respuesta es "No", la miniatura debe ser reajustada antes de su publicación.*

---

### 7.2 Matriz de A/B Testing de Lanzamiento (3 Variantes Obligatorias)

Cada episodio se lanza con un pool de **3 miniaturas preparadas para la herramienta nativa de "Test & Compare" de YouTube**:

```mermaid
graph TD
    A[Publicación del Episodio] --> B[Variante A: Fórmula 1 - Split Tritemporal]
    A --> C[Variante B: Fórmula 2 - Dive Vórtice FPV]
    A --> D[Variante C: Fórmula 4 o 5 - LiDAR 3D o Mega-Escala]
    B --> E{Algoritmo YouTube: 24-48 Horas}
    C --> E
    D --> E
    E -->|Métrica Clave: Watch Time Share / CTR| F[Ganador Definitivo Automático > 15%]
```

---

### 7.3 Checklist de Control de Calidad Pre-Publicación (10 Puntos)
...
- [ ] **4. Tipografía Bold con Stroke:** Tipografía `Syne ExtraBold` o `Space Grotesk` con stroke de 12-16px negro y sombra direccional.
